...
<Info>
  **Prerequisite**: You need an enterprise license to develop apps that connect to Vooma.
</Info>
...
<AccordionGroup>
  <Accordion title="Error: I'm seeing auth failures when I test my API key">
    You need to be an organization admin to create an API key. Please contact your admin or contact Vooma support.
  </Accordion>
